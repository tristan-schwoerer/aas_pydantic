...
class PropertyContainer(SubmodelElementCollection):
    ...
    property_multi_language_property: MultiLanguageProperty = MultiLanguageProperty(
...
class ComposedOfContainer(SubmodelElementCollection):
    ...
    capability_composed_of: RelationshipElement = RelationshipElement(
...
class GeneralizedBySet(SubmodelElementCollection):
    ...
    capability_generalized_by: RelationshipElement = RelationshipElement(
