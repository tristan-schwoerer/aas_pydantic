...
class Interface(SubmodelElementCollection):
    ...
    interface_profile_supplement: Property = Property(
        ...
        qualifiers=[
            Qualifier(type_="SMT/SMT/Cardinality", value="ZeroToOne", semantic_id="https://admin-shell.io/SubmodelTemplates/SMT/SMT/Cardinality/1/0"),
        ],
    )
...
class Errors(SubmodelElementCollection):
    ...
    error_reference__00__: ReferenceElement = ReferenceElement(
        ...
        description="A reference to an SMC \u201cError\u201d (Table 5) that that can be ",
        qualifiers=[
            Qualifier(type_="SMT/SMT/Cardinality", value="ZeroToMany", semantic_id="https://admin-shell.io/SubmodelTemplates/SMT/SMT/Cardinality/1/0"),
            Qualifier(type_="EditIdShort", value="True"),
            Qualifier(type_="EditDescription", value="True"),
...
class Modes(SubmodelElementCollection):
    ...
    mode__00__: Property = Property(
        ...
        qualifiers=[
            Qualifier(type_="PresetIdShort", value="To be filled; normally same as idShort, might be with {00}"),
            Qualifier(type_="SMT/SMT/Cardinality", value="OneToMany", semantic_id="https://admin-shell.io/SubmodelTemplates/SMT/SMT/Cardinality/1/0"),
        ],
    )
...
class Uses(SubmodelElementCollection):
    ...
    skill_reference__00__: ReferenceElement = ReferenceElement(
        ...
        description="A reference to an SMC \u201cSkill\u201d (Table 7) of this or another ",
        qualifiers=[
            Qualifier(type_="SMT/SMT/Cardinality", value="ZeroToMany", semantic_id="https://admin-shell.io/SubmodelTemplates/SMT/SMT/Cardinality/1/0"),
            Qualifier(type_="EditIdShort", value="True"),
            Qualifier(type_="EditDescription", value="True"),
